data = [
    # 🟩 Multiple Choice (10)
        ...
        },
        {
            ...
            "options": ["Hélène de Pourtalès", "Charlotte Cooper", "Alice Milliat", "Doris Fuchs"],
    ...
    # 🟨 Open Ended (10)
        ...
        {"question": "What is the name of the stadium where the 2008 Beijing Olympics opening ceremony took place?", "answer": "Bird’s Nest"},
